...
| **selectButtonText**      | _String_       | Set                            | Select button text title                                                                    |
| **searchPlaceHolderText** | _String_       | Search items                | Placeholder text for search field                                                           |
| **listEmptyTitle**        | _String_       | No items with that name found | Title to show when there's no item to be render                                             |
